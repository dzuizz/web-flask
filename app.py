...
contests = {
	...
	'HCIC': 'Hwa Chong Info-communications Challenge',
...
achievements = [
	{
		...
		'grade': 'Primary 6',
			'fulfilments': [
				{'title': 'HCIC', 'award': 'Platinum', 'ranking': '', 'filename': '2022HCIC.pdf'},
				...
				{'title': 'SMOPS by Hwa Chong Institution', 'award': 'GOLD', 'ranking': '', 'filename': '2022SMOPS.pdf'},
				{'title': 'Singa Global Final', 'award': 'GOLD', 'ranking': '', 'filename': '2022SINGA.pdf'},
				{'title': 'VANDA', 'award': 'GOLD', 'ranking': '', 'filename': ''},
	...
	},
	{
		...
		'fulfilments': [
			...
			{'title': 'DrCT Global Finals', 'award': 'GOLD', 'ranking': '1st Globally', 'filename': '2021DRCTGF.PDF'},
			...
			{'title': 'VANDA Global Final Individual', 'award': 'BRONZE', 'ranking': '', 'filename': '2021VANDAGFINDIVIDUAL.PDF'},
